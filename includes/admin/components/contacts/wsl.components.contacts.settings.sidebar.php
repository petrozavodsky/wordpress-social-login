...
<div class="postbox">
	<div class="inside">
		<h3><?php _e("User contacts import", 'wordpress-social-login') ?></h3>

		<div style="padding:0 20px;">
			<p>
				<?php _e( 'WordPress Social Login also allow you to import users contact list from Google Gmail, Facebook, Windows Live, LinkedIn  and Vkontakte', 'wordpress-social-login') ?>.
			</p> 

			<p>
				<?php _e( 'When enabled, users authenticating through WordPress Social Login will be asked for the authorisation to import their contact list. Note that some social networks do not provide certain of their users information like contacts emails, photos and or profile urls', 'wordpress-social-login') ?>.
			</p> 
			<hr />
			<p>
