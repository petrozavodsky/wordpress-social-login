...
<div class="stuffbox">
	<h3>
		<label><?php _e("Google", 'wordpress-social-login') ?></label>
	</h3>
	<div class="inside"> 
		<p class="description">
			<?php _e( 'To import Google\'s users contacts list you will have to go to <a href="https://console.developers.google.com" target="_blank">https://console.developers.google.com</a>, then <b>APIs &amp; auth</b> &gt; <b>APIs</b> and enable <b>Contacts API</b>', 'wordpress-social-login') ?>
		</p>
		<hr />
...
<div class="stuffbox">
	<h3>
		<label><?php _e("Facebook", 'wordpress-social-login') ?></label>
	</h3>
	<div class="inside"> 
		<p class="description">
			<?php _e( 'When enabled, Facebook\'s users will be asked for an extra permission to get access for their friends lists', 'wordpress-social-login') ?>
		</p>
		<hr />
...
<div class="stuffbox">
	<h3>
		<label><?php _e("Twitter", 'wordpress-social-login') ?></label>
	</h3>
	<div class="inside"> 
		<p class="description">
			<?php _e( 'This will only import the Twitter\'s users followed by the connected user on your website', 'wordpress-social-login') ?>
		</p>
		<hr />
...
<div class="stuffbox">
	<h3>
		<label><?php _e("LinkedIn", 'wordpress-social-login') ?></label>
	</h3>
	<div class="inside"> 
		<p class="description">
			<?php _e( 'To import LinkedIn\'s users contacts list you will have to go to <a href="https://www.linkedin.com/secure/developer" target="_blank">https://www.linkedin.com/secure/developer</a>, then <b>Default scope</b> and check <b>r_network</b>', 'wordpress-social-login') ?>
		</p>
		<hr />
...
<div class="stuffbox">
	<h3>
		<label><?php _e("Windows Live", 'wordpress-social-login') ?></label>
	</h3>
	<div class="inside"> 
		<hr />
...
<div class="stuffbox">
	<h3>
		<label><?php _e("Vkontakte", 'wordpress-social-login') ?></label>
	</h3>
	<div class="inside"> 
		<hr />
		<select name="wsl_settings_contacts_import_vkontakte" <?php if( ! get_option( 'wsl_settings_Vkontakte_enabled' ) ) echo "disabled" ?> >
			<option <?php if( get_option( 'wsl_settings_contacts_import_vkontakte' ) == 1 ) echo "selected"; ?> value="1"><?php _e("Enabled", 'wordpress-social-login') ?></option>
			<option <?php if( get_option( 'wsl_settings_contacts_import_vkontakte' ) == 2 ) echo "selected"; ?> value="2"><?php _e("Disabled", 'wordpress-social-login') ?></option>
		</select>
	</div>
</div>
<?php
